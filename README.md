...
| `data/mappings/current_fpl_understat_players.csv` | 1,684 | latest versioned operational player registry; 1,598 mapped |
| `data/mappings/current_fpl_understat_clubs.csv` | 30 | latest versioned operational club registry; 28 mapped |
| `data/mappings/fpl_understat_current.csv` | 577 | complete 2026-27 roster; 518 mapped, 59 unresolved |
